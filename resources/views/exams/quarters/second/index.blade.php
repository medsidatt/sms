...
@section('content')
    <div class="pagetitle">
        <h1 class="mb-1">List des note d'exement du 2<sup>em</sup> trimestre</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Exements</a></li>
                <li class="breadcrumb-item">Exement 2</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card w-auto">
                    <div class="card-body">
                        <div class="col"><p class="card-title">Tout les note d'exement du 2<sup>em</sup> trimestre</p></div>
                        <div class="row mb-2">
                            <form id="exam-form">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#send-button').click(function (e) {
                ...
                $.ajax({
                    url: "{{ route('exams.quarters.second') }}",
                    type: "POST",
                    data: data,
                    dataType: "JSON",
                    processData: false,
        ...
        function classFunc(event) {
            ...
            if (classId === '' && $.fn.DataTable.isDataTable('#exams')) {
                ...
                $.ajax({
                    url: "{{ route('exams.quarters.second.filtered', '') }}",
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: {
                        ...
                        action: function () {
                            $.ajax({
                                url: "{{ route('exams.quarters.second.delete') }}",
                                method: 'POST',
                                data: {id: id},
