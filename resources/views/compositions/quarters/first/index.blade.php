...
@section('content')
    ...
    <div class="pagetitle">
        <h1 class="mb-1">List des note du 1<sup>er</sup> composition</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                <li class="breadcrumb-item">1<sup>er</sup> Composition</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card w-auto">
                    <div class="card-body">
                        <div class="col"><p class="card-title">Tout les note du 1<sup>er</sup> composition</p></div>
        ...
        <script>
            ...
            function classFunc(event) {
                ...
                if (classId === '' && $.fn.DataTable.isDataTable('#exams')) {
                    ...
                    $.ajax({
                        url: "{{ route('compositions.quarters.first.filtered', '') }}",
            ...
            function showFunc(id, classId) {
                $.ajax({
                    ...
                    url: "{{ route('compositions.quarters.first.show') }}",
                    success: function (response) {
            ...
            function resultsToPdf() {
                $.ajax({
                    url: "{{ route('compositions.quarters.first.resultsToPdf') }}",
                    ...
                    success: function (response) {
                        ...
                        startY += 9;
                        doc.text('Resultat du 1er composition', 10, startY);
