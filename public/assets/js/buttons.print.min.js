...
!function (n) {
    ...
    var e = p.fn.dataTable, n = t.createElement("a");
    return e.ext.buttons.print = {
        ...
        action: function (t, e, n, o, r) {
            var i = e.buttons.exportData(p.extend({decodeEntities: !1}, o.exportOptions)), a = e.buttons.exportInfo(o),
                u = e.columns(o.exportOptions.columns).nodes().map(function (t) {
                    return t.className
                }).toArray(), s = '<table class="' + e.table().node().className + '">';
